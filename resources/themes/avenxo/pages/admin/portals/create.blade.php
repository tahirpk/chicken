					...
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form id="create_categpry" class="form-horizontal" method="post" action="{{URL::to('admin/create/category')}}">
                                                        {{ csrf_field() }}
                                                        @if(isset($portal))<input type="hidden" id="id" name="id" value="{{$portal->id}}" />@endif
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Name</label>
									<div class="col-sm-8">
                                                                            <input type="text" class="form-control" value="@if(isset($portal)){{$portal->title}}@endif" id="name" name="name" placeholder="Name">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
                                                                            <input type="text" class="form-control" value="@if(isset($portal)){{$portal->title}}@endif" id="matatags" name="matatags" placeholder="Tags">
									</div>
									<div class="col-sm-2">
										<!--<p class="help-block">Your help text!</p>-->
									</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">Portal Types</label>
									<div class="col-sm-8">
                                                                ...
                                                                @endif
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Introduction</label>
									<div class="col-sm-8"><textarea name="description" id="description" cols="50" rows="4" class="form-control">@if(isset($portal)){{$portal->description}}@endif</textarea></div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
                                                                            @if(isset($news) && !empty($portal->picture))<img  height="50" src="{{URL::to('uploads/portal/'.$portal->picture)}}" />@endif
									</div>
								</div>
							</form>
						</div>
