                                ...
                                <tbody>
                                    ...
                                    @foreach($categories as $category)
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="{{URL::to('admin/create/category/'.$category->id)}}">Edit</a>  <a href="{{URL::to('admin/delete/category/'.$category->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Delete</a></td>
