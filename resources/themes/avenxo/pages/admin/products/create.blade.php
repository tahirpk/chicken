...
<li><a href="{{URL::to('admin/product/list')}}">Products</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form id="create_categpry" class="form-horizontal" enctype="multipart/form-data" method="post" action="{{URL::to('admin/create/product')}}">
                                                        {{ csrf_field() }}
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <input type="text" class="form-control" value="@if(isset($category)){{$category->matatag}}@endif" id="matatag" name="matatag" placeholder="Tag">
									</div>
									<div class="col-sm-2">
										<!--<p class="help-block">Your help text!</p>-->
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
                                                                            <input type="text" class="form-control" value="@if(isset($category)){{$category->price}}@endif" id="price" name="price" placeholder="Price">
									</div>
									...
									<div class="col-sm-10">
                                                                            <input type="text" class="form-control" value="@if(isset($category)){{$category->quantity}}@endif" id="quantity" name="quantity" placeholder="Quantity">
									</div>
									...
									<div class="col-sm-2">
                                                                            @if(isset($category) && !empty($category->picture))<img  height="50" src="{{URL::to('uploads/products/'.$category->picture)}}" />@endif
									</div>
								</div>
                                                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Picture</label>
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><textarea name="short_discription" id="short_discription" cols="50" rows="4" class="form-control">@if(isset($category)){{$category->short_discription}}@endif</textarea></div>
								</div>
