...
<div class="page-content">
    <ol class="breadcrumb">
        ...
        <li><a href="javascript:;">News Categories</a></li>
                                ...
                                <tbody>
                                    ...
                                    @foreach($categories as $category)
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="{{URL::to('admin/create/blogcategory/'.$category->id)}}">Edit</a> | <a href="{{URL::to('admin/delete/blogcategory/'.$category->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Delete</a> | <a href="{{URL::to('admin/blog/list/'.$category->id)}}">Blog</a></td>
