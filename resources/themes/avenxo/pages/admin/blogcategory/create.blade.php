...
<li><a href="{{URL::to('admin/create/category')}}">News Category</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form id="create_categpry" class="form-horizontal" method="post" action="{{URL::to('admin/create/blogcategory')}}">
                                                        {{ csrf_field() }}
                                                        @if(isset($category))
                                                        <input type="hidden" id="id" name="id" value="{{$category->id}}" />@endif
								<div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <input type="text" class="form-control" value="@if(isset($category)){{$category->matatags}}@endif" id="matatags" name="matatags" placeholder="Tags">
									</div>
									<div class="col-sm-2">
										<!--<p class="help-block">Your help text!</p>-->
									</div>
