            ...
            <div class="row">
                        ...
                        @foreach($blogs as $blog)
                            <div class="blog row m0">
                                <div class="row m0 featureImg">
                                    <img title="{{$blog->title}}" src="@if(!empty($blog->picture)){{asset('uploads/blogs/'.$blog->picture)}}@else{{asset('assets/image.png')}}@endif"  />
                                </div>
                                <div class="row m0 titleRow">
                                    ...
                                    <div class="fleft titlePart">
                                        <a href="{{URL::to('blog/post/'.$blog->slug)}}"><h4 class="blogTitle heading">{!!$blog->title!!}</h4></a>
                                       
                                        <p class="m0">By <a href="#">{{$blog->users->username}}</a><!--<span>|</span><a href="#">5 Comments</a>--></p>
                                    </div>
                                </div>
                                <div class="row m0 excerpt">
                                    {{{str_limit(strip_tags($blog->description), $limit = 400, $end = '...')}}}
                                </div>
                            </div> <!--Blog Row End-->
                        @endforeach
                ...
                <div class="col-sm-4">
                    <div class="row m0 sidebar">
                        <form method="get" action="{{URL::to('blog/categories')}}" class="searchForm row m0">
                        ...
                        <div class="row m0 categories">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="{{URL::to('blog/categories?id='.$bcategory->id)}}"> {!!$bcategory->name!!}</a></li>
                                @endforeach
