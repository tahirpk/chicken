...
<div class="page-content">
    <ol class="breadcrumb">
        ...
        <li><a href="javascript:;">Portal Projects</a></li>
                                ...
                                <tbody>
                                    ...
                                    @foreach($portals as $category)
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="{{URL::to('admin/create/project/'.$category->id)}}">Edit</a>  <a href="{{URL::to('admin/delete/project/'.$category->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Delete</a></td>
