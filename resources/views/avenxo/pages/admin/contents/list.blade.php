                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                                ...
                                <tbody>
                                    ...
                                    @foreach($pages as $page)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>{{$page->title}}</td>
                                            <td>{{$page->status}}</td>
                                            <td class="center"><a href="{{URL::to('admin/create/page/'.$page->id)}}">Edit</a>  <a href="{{URL::to('admin/delete/page/'.$page->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Delete</a></td>
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="example_info" role="status" aria-live="polite">Showing 1 to 10 of {{$pages->total()}} entries</div>
