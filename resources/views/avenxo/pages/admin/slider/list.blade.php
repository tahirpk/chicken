                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                            ...
                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach($sliders as $slider)
                                        <tr class="odd gradeX">
                                            <td><?php echo ++$i;?></td>
                                            <td>{{$slider->slider_key}}</td>
                                            <td>{{$slider->heading}}</td>
                                            <td>{{$slider->button_one}}</td>
                                            <td>{{$slider->button_two}}</td>
                                            <td>{{$slider->status}}</td>
                                            <td class="center"><a href="{{URL::to('admin/create/slider/'.$slider->id)}}">Edit</a> <a href="{{URL::to('admin/slider/image/list/'.$slider->id)}}">Images List</a>   <a href="{{URL::to('admin/create/slider/images/'.$slider->id)}}">Add Images</a>  <a href="{{URL::to('admin/delete/slider/'.$slider->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Delete</a></td>
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="example_info" role="status" aria-live="polite">Showing 1 to 10 of {{$sliders->total()}} entries</div>
