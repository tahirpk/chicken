                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                            ...
                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach($sliderimages as $slider)
                                        <tr class="odd gradeX">
                                            <td><?php echo ++$i;?></td>
                                            <td><img src='{{Asset("uploads/slider/".$slider->image)}}' style="max-width:250px;" /></td>
                                            
                                            <td>{{$slider->button_one}}</td>
                                            <td>{{$slider->button_two}}</td>
                                            <td>{{$slider->status}}</td>
                                            <td class="center"> <a href="{{URL::to('admin/delete/slider/'.$slider->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Delete</a></td>
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="example_info" role="status" aria-live="polite">Showing 1 to 10 of {{$sliderimages->total()}} entries</div>
