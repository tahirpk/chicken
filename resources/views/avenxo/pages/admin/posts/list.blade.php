...
<div class="page-content">
    <ol class="breadcrumb">
        ...
        <li><a href="javascript:;">Blog Posts</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                                ...
                                <tbody>
                                    ...
                                    @foreach($blogs as $blog)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>{{$blog->title}}</td>
                                            <td>{{$blog->status}}</td>
                                            <td class="center"><a href="{{URL::to('admin/create/blog/'.$blog->id)}}">Edit</a>  <a href="{{URL::to('admin/delete/blog/'.$blog->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Delete</a></td>
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="example_info" role="status" aria-live="polite">Showing 1 to 10 of {{$blogs->total()}} entries</div>
