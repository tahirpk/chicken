...
<div class="page-content">
    <ol class="breadcrumb">
        ...
        <li><a href="javascript:;">Portal Categories</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                                ...
                                <tbody>
                                    ...
                                    @foreach($categories as $category)
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="{{URL::to('admin/create/portalcategory/'.$category->id)}}">Edit</a> | <a href="{{URL::to('admin/delete/portalcategory/'.$category->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Delete</a> | <a href="{{URL::to('admin/project/list/'.$category->id)}}" onclick="return confirm('Sure, you want to delete this category?')">Projects</a></td>
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="example_info" role="status" aria-live="polite">Showing 1 to 10 of {{$categories->total()}} entries</div>
