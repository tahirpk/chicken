...
<li><a href="{{URL::to('admin/create/portalcategory')}}">Portal Category</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form id="create_categpry" class="form-horizontal" method="post" action="{{URL::to('admin/create/portalcategory')}}">
                                                        {{ csrf_field() }}
