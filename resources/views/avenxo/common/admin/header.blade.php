<header id="topnav" class="navbar navbar-default navbar-fixed-top" role="banner">
	...
	<div class="logo-area">
		...
		<a class="navbar-brand" href="{{URL::to('/')}}">Avenxo</a>

		<div class="toolbar-icon-bg hidden-xs" id="toolbar-search">
            @if (Auth::check())
            <form method="get"  action="{{URL::to('videos/search')}}">
                <div class="input-group">
            	<span class="input-group-btn"><button class="btn" type="button"><i class="ti ti-search"></i></button></span>
                <input type="text" name="key" required class="form-control" placeholder="Search...">
				<span class="input-group-btn"><button class="btn" type="submit"><i class="ti ti-close"></i></button></span>
			</div>
            </form>
	...
	<ul class="nav navbar-nav toolbar pull-right">
		...
		<li class="dropdown toolbar-icon-bg">
			...
			<ul class="dropdown-menu userinfo arrow">
				...
				<li class="divider"></li>
				<li><a href="{{URL::to('admin/logout')}}"><i class="ti ti-shift-right"></i><span>Sign Out</span></a></li>
			</ul>
		</li>
