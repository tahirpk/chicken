...
class CategoryController extends Controller {
    ...
    public function index() {
        if (Permission::hasAccess('view', 'category')) {
            ...
            return view(Config::get('config.template') . '.pages.admin.category.list')->withCategories($categories);
        }
    ...
    public function create() {
        if (Permission::hasAccess('create', 'category')) {
            ...
            return view(Config::get('config.template') . '.pages.admin.category.create')->withCategories($categories);
        }
        return Redirect::to('admin/error/404');
    }
    ...
    public function edit($id) {
        if (Permission::hasAccess('edit', 'category')) {
            ...
            return view(Config::get('config.template') . '.pages.admin.category.create')->withCategory($category)->withCategories($categories);
        }
        return Redirect::to('admin/error/404');
    }
