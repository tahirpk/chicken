...
$(window).load(function() {
    ...
    $('#productImageSliderNav0').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: true,
        ...
        itemWidth: 130,
        itemMargin: 10,
        asNavFor: '#productImageSlider0',
        prevText: '<i class="fa fa-angle-left"></i>',
        nextText: '<i class="fa fa-angle-right"></i>', 
    });

    $('#productImageSlider0').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: false,
        slideshow: false,
        sync: "#productImageSliderNav0"
    });
    
    $('#productImageSliderNav1').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: true,
        ...
        itemWidth: 130,
        itemMargin: 10,
        asNavFor: '#productImageSlider1',
        prevText: '<i class="fa fa-angle-left"></i>',
        nextText: '<i class="fa fa-angle-right"></i>', 
    });

    $('#productImageSlider1').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: false,
        slideshow: false,
        sync: "#productImageSliderNav1"
    });
    
    $('#productImageSliderNav2').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: true,
        ...
        itemWidth: 130,
        itemMargin: 10,
        asNavFor: '#productImageSlider2',
        prevText: '<i class="fa fa-angle-left"></i>',
        nextText: '<i class="fa fa-angle-right"></i>', 
    });

    $('#productImageSlider2').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: false,
        slideshow: false,
        sync: "#productImageSliderNav2"
    });
    
    $('#productImageSliderNav3').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: true,
        ...
        itemWidth: 130,
        itemMargin: 10,
        asNavFor: '#productImageSlider3',
        prevText: '<i class="fa fa-angle-left"></i>',
        nextText: '<i class="fa fa-angle-right"></i>', 
    });

    $('#productImageSlider3').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: false,
        slideshow: false,
        sync: "#productImageSliderNav3"
    });
    
    $('#productImageSliderNav4').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: true,
        ...
        itemWidth: 130,
        itemMargin: 10,
        asNavFor: '#productImageSlider4',
        prevText: '<i class="fa fa-angle-left"></i>',
        nextText: '<i class="fa fa-angle-right"></i>', 
    });

    $('#productImageSlider4').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: false,
        slideshow: false,
        sync: "#productImageSliderNav4"
    });
    
    $('#productImageSliderNav5').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: true,
        ...
        itemWidth: 130,
        itemMargin: 10,
        asNavFor: '#productImageSlider5',
        prevText: '<i class="fa fa-angle-left"></i>',
        nextText: '<i class="fa fa-angle-right"></i>', 
    });

    $('#productImageSlider5').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        directionNav: false,
        slideshow: false,
        sync: "#productImageSliderNav5"
    });
