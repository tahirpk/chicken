...
| -------------------------------------------------------------------*/
	...
	///netsocms/public/uploads/news/VH1Vrsh393.jpg
                
	$config['img_path'] = '/netsocms/public/uploads'; // Relative to domain name
...
/*
        if (isset($_SERVER['DOCUMENT_ROOT'])){
            ...
            $config['upload_path'] = "C:\xampp\htdocs\netsocms\public\uploads" . $config['img_path'];
        }
  */      
